...
class topicsController {
    ...
    public async create(req: Request,res: Response): Promise<void>{
        ...
        var sql_statement = "CALL ng_blog_db.INSERT_TOPICS('" + req.body['name'] + "','" + req.body['description'] + "')";
        console.log(sql_statement);
    ...
    public async update(req: Request,res: Response): Promise<void>{
        const { id } = req.params;
        var sql_statement = "CALL ng_blog_db.UPDATE_TOPIC_byId('" + id + "','"  + req.body['name'] + "','" + req.body['description'] + "')";
        console.log(sql_statement);
        await pool.query(sql_statement);
...
const topicssController = new topicsController();
